...
export default class Orders extends Component {
    ...
    getOrders() {
        axios.get(`${url}/orders`, { headers: headers })
        .then(res => {
                    ...
                    <Topbar/>
                        ...
                        <div className="row">
                            ...
                            <div className="card shadow mb-4">
                                ...
                                <h6 className="m-0 font-weight-bold text-primary">Available Orders</h6>
                                ...
                                <div className="card-body">
                                    <div className="table-responsive">
                                                    ...
                                                    <table className="table table-striped">
                                                        ...
                                                        <tbody>
                                                        {this.state.orders.sort((a, b) => { return a._id < b._id}).map((data, i) => 
                                                                <tr key={i}>
                                                                    {/* <td>{data.slot}</td> */}
                                                                    <td>{data.product}</td>
                                                                    <td> 
